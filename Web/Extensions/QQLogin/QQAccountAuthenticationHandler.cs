...
{
    internal class QQAccountAuthenticationHandler : AuthenticationHandler<QQAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                context.Identity = new ClaimsIdentity(new[]{
                    ...
                    new Claim("urn:QQ:id", context.Id,XmlSchemaString,Options.AuthenticationType),
                    new Claim("urn:QQ:name", context.Name,XmlSchemaString,Options.AuthenticationType),
                    new Claim("urn:QQ:avatar",context.User["figureurl_qq_2"].ToString(),XmlSchemaString,Options.AuthenticationType)
                });
